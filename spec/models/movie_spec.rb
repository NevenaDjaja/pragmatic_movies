...
describe 'A movie' do 
	...
	it 'requires a realeased_on date' do
	...
	it 'requires a description over 24 characters' do
		movie = Movie.new(description: "A" * 20)
		movie.valid?
		expect(movie.errors[:description].any?).to eq(true)
	end
	...
	it 'rejects the negative total gross' do
	...
	it 'rejects not properly formatted image file names' do
	...
	it 'accepts any rating in the approved list' do
	...
	it 'rejects any rating in the approved list' do
